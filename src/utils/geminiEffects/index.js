...
export const initGeminiButtonEffects = () => {
  ...
  const extractAudioButtons = document.querySelectorAll('.extract-audio-button');
  ...
  [...generateButtons, ...retryButtons, ...forceStopButtons, ...srtUploadButtons, ...extractAudioButtons].forEach(button => {
