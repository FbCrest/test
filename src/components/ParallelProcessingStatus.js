            ...
            >
              ...
              {segment.status === 'pending' && !retryingSegments.includes(index) && onGenerateSegment && (
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    // [LOG_REMOVED] 'Generate button clicked for segment', index);
                  ...
                  {openDropdownIndex === index && (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          // [LOG_REMOVED] 'Retry with Gemini 2.5 Pro for segment', index);
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          // [LOG_REMOVED] 'Retry with Gemini 2.5 Flash for segment', index);
                          onRetryWithModel(index, 'gemini-2.5-flash-preview-05-20');
                          setOpenDropdownIndex(null);
                        }}
                      >
                        <div className="model-option-icon model-flash">
                          <FiZap size={14} style={{ color: 'var(--md-tertiary)' }} />
                        </div>
                        <div className="model-option-text">
                          <div className="model-option-name">{t('models.gemini25Flash', 'Gemini 2.5 Flash')}</div>
                          <div className="model-option-desc">{t('models.smarterFaster', 'Smarter & faster')}</div>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          // [LOG_REMOVED] 'Retry with Gemini 2.0 Flash for segment', index);
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          // [LOG_REMOVED] 'Retry with Gemini 2.0 Flash Lite for segment', index);
