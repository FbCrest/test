...
import { FiChevronDown, FiStar, FiAward, FiZap, FiCpu, FiCheckCircle } from 'react-icons/fi';
 ...
 * @param {Function} props.renderBadge - Function to render a badge for a model
            ...
            {modelOptions.map((model) => (
              ...
              >
                ...
                <div className="model-option-text">
                  <div className="model-option-name">{model.name}
                    {renderBadge && renderBadge(model.id)}
                  </div>
