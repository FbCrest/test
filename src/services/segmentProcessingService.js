...
export async function processSegment(segment, segmentIndex, startTime, segmentCacheId, onStatusUpdate, t, mediaType = 'video') {
    ...
    while (!success && retryCount < maxRetries) {
        ...
        try {
            ...
            retryCount++;
            console.error(i18n.t('errors.segmentProcessFailed', 'Error processing segment'), error);
            ...
            try {
                ...
                console.error(i18n.t('errors.segmentParseError', 'Error parsing error message'), parseError);
            }
    ...
    if (success && segmentSubtitles) {
        try {
            ...
            console.error(i18n.t('errors.segmentCacheFailed', 'Error caching segment subtitles'), error);
